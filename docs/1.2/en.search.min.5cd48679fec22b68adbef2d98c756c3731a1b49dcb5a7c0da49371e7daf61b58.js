...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.02079af3a18a825c3514690103b60d4341e1db7f85547aa70f4a19da844d4373.js',function(){input.required=false;search();});}
